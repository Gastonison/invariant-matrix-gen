...
def calculate_column_values(a, b, k):
    for i in range(k):
        ...
        a_generated[i] = a[i]
        a_generated = sorted(a_generated)
        mergedArrays = mergeArrays(a_generated, b)
        j=enumeration_dictionary(tuple(mergedArrays))
...
for i in range(10,500):
    timerValue = time.time()
    matrix_data, generated_dictionary = generate_matrix(5,i)
