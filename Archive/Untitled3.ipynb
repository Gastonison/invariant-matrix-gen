   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Populating enumerated list took 0.0473248958588 seconds\n",
      "Generating Matrix took: 0.405268907547 seconds\n",
      "Computing rank took: 0.762148857117 seconds\n",
      "200 1852\n",
      "-------------------------\n",
      "Populating enumerated list took 0.0482630729675 seconds\n",
      "Generating Matrix took: 0.438741922379 seconds\n",
      "Computing rank took: 2.5974149704 seconds\n",
      "201 1752\n",
      "-------------------------\n"
     ]
    }
