...
# def evaluate_permutations(perm, initial_row, )

# Handles what to do with each iterated permutation
def evaluate_permutation(a, b, k, row, dictionary):
